...
| 主题 | 链接 |
|------|------|
| EU 合规声明（内容） | [Art. 47 说明](/zh/08-konformitaet/konformitaetserklaerung) |
| EU 合规声明（模板） | [模板](/zh/templates/konformitaetserklaerung) |
| EU 数据库注册 | [Art. 49](/zh/08-konformitaet/registrierung) |
| CE 标志 | [Art. 48](/zh/08-konformitaet/ce-kennzeichnung) |
| 风险分类 | [第 2 章](/zh/02-risikoklassifizierung/) |
