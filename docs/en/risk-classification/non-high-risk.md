...
::: danger Profiling = always high-risk
If an Annex III system performs profiling (automated processing of personal data to evaluate personal aspects such as work performance, economic situation, health, interests, behaviour), the exception **does not apply**.
:::
