...
| **02.08.2025** | GPAI obligations (Art. 51–56), governance infrastructure, sanctions regime | ✅ Applicable | Relevant only as GPAI deployer |
| **02.08.2026** | High-risk AI systems (Art. 6–49), transparency obligations (Art. 50), all remaining obligations | ⏳ Deadline | **Main deadline** – all high-risk systems must be compliant |
| **02.08.2027** | High-risk AI as safety components in regulated products (Annex I Section A) | ⏳ Deadline | Embedded AI in machinery, medical devices etc. |

::: danger Digital Omnibus – Possible Postponement
The European Commission proposed a "Digital Omnibus" package in late 2025 that could postpone the high-risk obligations for Annex III systems until **December 2027**. BAUER GROUP plans conservatively with **August 2026** as the binding deadline.
:::
