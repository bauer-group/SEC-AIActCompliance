...
High-risk AI systems shall only be placed on the EU market if the [Go/No-Go assessment](/en/01-ueberblick/go-no-go) yields a positive outcome. The following pages document the complete requirements in the event of a Go decision.
:::
