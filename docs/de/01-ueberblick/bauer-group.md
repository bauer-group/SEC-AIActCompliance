...
| Produkt / Projekt | KI-Komponente | Voraussichtliche Risikostufe | Go/No-Go |
|---|---|---|---|
| *Wird produktspezifisch befüllt* | — | — | — |

::: info
Die konkrete Produktliste ist ein internes Dokument und wird im [KI-System-Inventar](/de/templates/ki-inventar) gepflegt. Diese Seite dokumentiert nur die strategische Positionierung.
:::
