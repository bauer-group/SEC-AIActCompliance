...
| Thema | Link |
|-------|------|
| EU-Konformitätserklärung (Inhalt) | [Art. 47 Erläuterung](/de/08-konformitaet/konformitaetserklaerung) |
| EU-Konformitätserklärung (Template) | [Template](/de/templates/konformitaetserklaerung) |
| EU-Datenbank-Registrierung | [Art. 49](/de/08-konformitaet/registrierung) |
| CE-Kennzeichnung | [Art. 48](/de/08-konformitaet/ce-kennzeichnung) |
| Risikoklassifizierung | [Kapitel 2](/de/02-risikoklassifizierung/) |
